        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-aqua-active">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Abertura</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-green-active">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Fechamento</span>
            ...
            <div class="modal-dialog .modal-align-center">
                <div class="modal-content">
                    ...
                    <form action="{{route('prediction')}}" method="POST">
                        {{ csrf_field() }}
                        <input style="display: none" type="text" name="coins" value="Petr4">
                        <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                <h5 style="color: #0b93d5">Cada dia corresponde a uma previsão de valor futura </h5>
                            </div><br>
                        </div>
